...
**Docker Architecture:**
- **prog service**: Multi-stage build (GAlib → C++ library → Python runtime)
...
- Automatic makefile patching for modern compilers (g++-4.4 → g++, k8-sse3 → native, Python 2.5 → 2.7)
...
- Line 26: `-I/usr/local/include/python2.5` → adjust to your Python 2.x path
