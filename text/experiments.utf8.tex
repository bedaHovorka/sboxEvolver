...
vhodné pro hledání zvolených velikostí s-boxů.
Za tím účelem bylo provedeno porovnání s náhodným prohledáváním.
Porovnání běhů dle statistik z Galibu \cite{galib} bylo provedeno na několika bězích.
Experimenty byly naskriptovány pomocí Pythonu.
Byly vybrány na základě testování programu, kde proběhly jednoběhové zkoušky
...
Poté se tyto parametry použily pro náročnější experimenty.
...
a všichni jedinci ze všech běhů pro jednu dvojici $(p_{Mut}, p_{Cross})$ byli sloučeni
...
Na rozdíl od předchozího však nebyla hledána bijektivní funkce.
